...
import {
  ...
  MATERIALS,
  MODELS,
} from "@/validators/option-valitdator";
...
const DesignConfigurator = ({
  ...
  async function saveConfiguration() {
    try {
      ...
      const actualIX = renderedPosition.x - leftOffset;
      const actualIY = renderedPosition.y - topOffset;
      ...
      toast({
        title: "Something went wrong",
        description: "There was a problem with saving your config, please try again.",
        variant: "destructive"
      })
    }
  }
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      <div ref={containerRef} className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/181]">
          <AspectRatio
            ref={phoneCaseRef}
            ratio={896 / 1831}
          ...
          <div className="absolute z-40 inset-0 left-[3px] top-px right-[3px] button-px rounded-[32px] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]" />
          <div
            className={cn(
              "absolute inset-0 top-px right-[3px] bottom-px rounded-[32px]",
              `bg-${options.color.tw}`,
            )}
          />
        </div>
