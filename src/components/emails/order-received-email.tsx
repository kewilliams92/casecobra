...
import { Head, Preview, Html, Body, Container, Section, Img, Heading, Text, Hr, Row, Column } from "@react-email/components";
...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
  const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://casecobra-gules.vercel.app'
  return (
    <Html>
      <Head />
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img src={`${baseUrl}/snake-3.png`} alt="delivery snake" width='65' height='73' style={{ margin: 'auto' }} />
            <Heading style={global.heading}>
              Thank you for your order!
            </Heading>
            <Text style={global.text}>
              We're preparing everything for delivery and will notify you once your package has been shipped.  Delivery usually takes 5-7 buisness days.
            </Text>
            <Text style={global.text}>
